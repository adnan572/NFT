...
const Hero = () => {
  return (
    <section className="max-w-[1440px] flex justify-center items-center  bg-black/5 backdrop-blur-sm px-8 py-6 border border-black/50 rounded-md max-md:flex-col max-md:w-full mx-auto max-md:px-4 max-md:py-3">
